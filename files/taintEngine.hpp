   ...
   */
     ...
     */
      ...
      class TaintEngine {
        ...
        public:
          //! Constructor.
          TRITON_EXPORT TaintEngine(const triton::modes::SharedModes& modes, triton::engines::symbolic::SymbolicEngine* symbolicEngine, triton::arch::CpuInterface& cpu, triton::arch::Architecture* architecture);
          ...
          //! Returns true if the addr is tainted.
          TRITON_EXPORT bool isMemoryTainted2(triton::uint64 addr, triton::uint32 size=1) const;
          ...
          //! Returns true if the memory is tainted.
          TRITON_EXPORT bool isMemoryTainted2(const triton::arch::MemoryAccess& mem, bool mode=true) const;

          //! Returns true if the register is tainted.
          TRITON_EXPORT bool isRegisterTainted(const triton::arch::Register& reg) const;

          //! Returns true if the register is tainted.
          TRITON_EXPORT bool isRegisterTainted2(const triton::arch::Register& reg) const;
